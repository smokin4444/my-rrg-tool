...
with st.sidebar:
    st.header("🎯 Watchlist")
    group_choice = st.radio("Choose Group:", ["Major Themes", "Sector Rotation", "Hard Assets (Live)", "TV Industries (Full)", "Income Stocks", "Single/Custom"])
    
    current_list = {"Major Themes": MAJOR_THEMES, "Sector Rotation": SECTOR_ROTATION, "Hard Assets (Live)": HARD_ASSETS_LIVE, "TV Industries (Full)": TV_INDUSTRIES_FULL, "Income Stocks": INCOME_STOCKS, "Single/Custom": ""}.get(group_choice)
