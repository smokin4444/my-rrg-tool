...
TICKER_NAMES = {
    ...
    "CL=F": "CRUDE OIL (Live)", "BZ=F": "BRENT OIL (Live)", "NG=F": "NAT GAS (Live)", "PL=F": "PLATINUM (Live)"
}
...
HARD_ASSETS_LIVE = "GC=F, SI=F, HG=F, CL=F, BZ=F, NG=F, PL=F"
CUSTOM_LIST = ""
...
with st.sidebar:
    ...
    elif heap_type == "Hard Assets (Live)": current_list, auto_bench = HARD_ASSETS_LIVE, "GC=F"
...
try:
    ...
    st.error(f"Engine Alert: {e}. Check for data gaps in the Startup group.")
